...
client.user.setActivity(`discord.gg/lena`)
...
const { joinVoiceChannel } = require('@discordjs/voice');
 client.on('ready', () => { 
   joinVoiceChannel({
    channelId: "1045078215208738837",
    guildId: "1045077611858112512",       
    adapterCreator: client.guilds.cache.get("1045077611858112512").voiceAdapterCreator
   });
   }); 
